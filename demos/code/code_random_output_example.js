...
Code.constructWorkspace = function() {
  ...
  +'<block type="alexa_structure" id="f{n~Jq?a_qMP1R8:W~+@" x="10" y="10">'
    +'<statement name="ALEXA_CODE">'
      +'<block type="alexa_invocationtrigger" id="(F.`xv]R1dpvOQY5vU)i">'
        +'<statement name="HANDLER_CODE">'
          +'<block type="controls_if" id="QHNIw=l{4$6S6)agG-Cr">'
            +'<mutation elseif="2"/>'
            +'<value name="IF0">'
              +'<block type="logic_compare" id="I}ZpT-fh|^jNn2pj[qT!">'
                +'<field name="OP">EQ</field>'
                +'<value name="A">'
                  +'<block type="math_random_int" id="7UNh{C;#Hc}Etp%Zjy5W">'
                    +'<value name="FROM">'
                      +'<shadow type="math_number" id="RlEVdg)oMsw:QVJuY4GM">'
                        +'<field name="NUM">1</field>'
                      +'</shadow>'
                    +'</value>'
                    +'<value name="TO">'
                      +'<shadow type="math_number" id="0F|j8?0PqC.qW3ws1+aA">'
                ...
                +'</value>'
                +'<value name="B">'
                  +'<block type="math_number" id="%Bi_4MbrD2qep`CM+r{f">'
                    +'<field name="NUM">1</field>'
                  +'</block>'
                +'</value>'
              +'</block>'
            +'</value>'
            +'<statement name="DO0">'
              +'<block type="alexa_speech" id="y{L$@)ql}N2%NGj$-~MT">'
                +'<value name="SPEECH">'
                  +'<block type="text" id="o+Qtgv~uTupk8B@PHQ3|">'
                    +'<field name="TEXT">Output 1</field>'
                  +'</block>'
                +'</value>'
              +'</block>'
            +'</statement>'
            +'<value name="IF1">'
              +'<block type="logic_compare" id="W{aWGL}]_HZV1s1-/K18">'
                +'<field name="OP">EQ</field>'
                +'<value name="A">'
                  +'<block type="math_random_int" id="7UNh{C;#Hc}Etp%Zjy5W">'
                    +'<value name="FROM">'
                      +'<shadow type="math_number" id="FRXKH+d[m?tk)e%jAF:;">'
                        +'<field name="NUM">1</field>'
                      +'</shadow>'
                    +'</value>'
                    +'<value name="TO">'
                      +'<shadow type="math_number" id="kbRf^M%:L%RoCa11nbWM">'
                        +'<field name="NUM">3</field>'
                      +'</shadow>'
                    +'</value>'
                  +'</block>'
                +'</value>'
                +'<value name="B">'
                  +'<block type="math_number" id="Yyv6kfb-N[4bp%LgG-/c">'
            ...
            +'</value>'
            +'<statement name="DO1">'
              +'<block type="alexa_speech" id=":Wj+.G:HI=kr`K/6=c|`">'
                +'<value name="SPEECH">'
                  +'<block type="text" id="*BD=#g8:5Y%L(pfDfLBX">'
                    +'<field name="TEXT">Output 2</field>'
                  +'</block>'
                +'</value>'
              +'</block>'
            +'</statement>'
            +'<value name="IF2">'
              +'<block type="logic_compare" id="2M*3Dr4@AW,-bpW6HY}g">'
                +'<field name="OP">EQ</field>'
                +'<value name="A">'
                  +'<block type="math_random_int" id="7UNh{C;#Hc}Etp%Zjy5W">'
                    +'<value name="FROM">'
                      +'<shadow type="math_number" id="7K]o#9yK^qm~PM+R!W^R">'
                        +'<field name="NUM">1</field>'
                      +'</shadow>'
                    +'</value>'
                    +'<value name="TO">'
                      +'<shadow type="math_number" id="~9p;e=w[/4#+U/~D!}ha">'
                        +'<field name="NUM">3</field>'
                      +'</shadow>'
                    +'</value>'
                  +'</block>'
                +'</value>'
                +'<value name="B">'
                  +'<block type="math_number" id="*D}Kiy]k~,*QR(:@E.l+">'
                    +'<field name="NUM">3</field>'
                  +'</block>'
                +'</value>'
              +'</block>'
            +'</value>'
            +'<statement name="DO2">'
              +'<block type="alexa_speech" id="TexSW;,1Tw{n?|xb0INA">'
                +'<value name="SPEECH">'
                  +'<block type="text" id="h?EP!jbADI}ki;EjnzY`">'
                    +'<field name="TEXT">Output 3</field>'
                  +'</block>'
                +'</value>'
              +'</block>'
            +'</statement>'
  ...
  +'</block>'
+'</xml>';
  Blockly.Xml.domToWorkspace(Blockly.Xml.textToDom(structure), Code.workspace); 
};
...
Code.initLanguage = function() {
  ...
  var comp = function(a, b) {
    // Sort based on first argument ('English', 'Руѝѝкий', '简体字', etc).
    if (a[0] > b[0]) return 1;
    if (a[0] < b[0]) return -1;
    return 0;
  };
